  ...
  return (
    <Layout>
      <div className="relative flex flex-col items-center justify-center p-4 sm:p-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 inline-block bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] text-transparent bg-clip-text">الشروط والأحكام</h2>
        <div className="text-white rounded-xl shadow p-4 sm:p-8 leading-relaxed text-right text-base sm:text-lg">
          <h2 className="text-lg sm:text-xl font-bold mb-4">مقدمة</h2>
          ...
          <h2 className="text-lg sm:text-xl font-bold mb-4 mt-8">استخدام الموقع</h2>
          <ul className="list-disc pr-4 sm:pr-6 space-y-2 mb-4">
          ...
          <h2 className="text-lg sm:text-xl font-bold mb-4 mt-8">حقوق الملكية الفكرية</h2>
          ...
          <h2 className="text-lg sm:text-xl font-bold mb-4 mt-8">سياسة الخصوصية</h2>
          ...
          <h2 className="text-lg sm:text-xl font-bold mb-4 mt-8">تعديلات الشروط</h2>
          ...
          <h2 className="text-lg sm:text-xl font-bold mb-4 mt-8">الاتصال بنا</h2>
